...
O texto e' voltado ao usuario, logo ACENTUADO (CLAUDE.md §2), e e' HONESTO sobre a
idade por dimensao: o trimestre atualiza o EMPREGO (CAGED, mensal); renda, PIB,
empresas e populacao seguem nas safras anuais das suas fontes, e o satelite e'
2016-2023 estatico. Fingir que tudo atualizou seria o "documento com numero que
envelhece calado" em forma de mensagem.
...
def montar_sucesso(resumo: dict[str, Any]) -> str:
    ...
    linhas = [
        ...
        f"Vereditos antes: {_linha_vereditos(resumo.get('vereditos_antes') or {})}.",
        f"Vereditos depois: {_linha_vereditos(resumo.get('vereditos_depois') or {})}.",
        (
            "Lembrete de idade por dimensão: renda, população e empresas seguem "
