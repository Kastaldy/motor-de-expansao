...
**A decisão de arquitetura (DEC-046).** **Instância por país, com o país DECLARADO num `perfil.json`
...
**Fronteira de repositório (§1.1 do plano; DEC-046).** UM repositório de **PLATAFORMA** (este) — o
...
| **DEC / Spec** | [DEC-046](../docs/decisions/DEC-046.md) ✅ registrada · **`docs/spec_bloco_a_perfil.md`** ✅ (37 sítios, 10 commits, 10 aceites por comando) — **quem for codar lê os números de lá**, não do plano: as citações de `web/server/app.py` acima da linha ~3200 no plano estão **14 linhas defasadas**, e a tabela de conversão está no §0 da spec. |
