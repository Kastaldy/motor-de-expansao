...
def test_o_item_da_ficha_declara_de_QUAL_app_a_academia_veio():
    """`[DEC-064]` A `fonte` sai da PRÓPRIA linha da união — não da tabela de fatos.
...
def test_o_item_da_ficha_declara_quando_esta_nos_DOIS_apps():
    """`[DEC-064 / fatia 2]` A ficha tambem desenha o terceiro estado.

    Mesma razao do item do payload: a coluna sai da PROPRIA linha da uniao (a DEC-064 a poe em
