...
def test_15_contratos_e_as_quatro_versoes_bumpadas() -> None:
    ...
    # `[DEC-064]` 25 desde `alvos_ma_nomeados_v8`: entra `fontes_da_academia` (quais apps
    ...
    # `[DEC-064]` os quatro sobem de novo: o TotalPass entra na OFERTA do s6 (independentes e as
