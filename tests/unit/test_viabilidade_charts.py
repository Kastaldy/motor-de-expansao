...
def test_pdf_do_payload_mantem_a_contagem_de_paginas():
    ...
    BLK-RELPON-14: a linha de base do PDF desceu 10 -> 9 paginas com a remocao do slide
    "Imagem do Entorno". As 2 paginas de viabilidade seguem intactas — o que muda e o
    total, nao a contribuicao deste modulo.
    """
