...
def main() -> None:
    ...
    if faltando_ma:
        ...
        print("  -> O recorte de fontes: omitir `--fontes` aplica o default da DEC-066,")
        ...
        print("     ranking e' o SINAL 1 (`s1` em SINAIS_INATIVOS, fato sem peso), nao a")
        print("     fonte. Religa-lo exige, no MESMO ato, leva-lo ao grao por ACADEMIA.")
