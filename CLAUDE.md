...
| [DEC-023](docs/decisions/DEC-023.md) | 2026-08-04 | Alta | Extensão do escopo de coleta do GymScraping: nota in-app do WellHub (`partnerRating`) como agregado numérico, com schema de 2 colunas e estados distinguíveis (BLK-MA-08); fatia o gate conjunto MA-08/MA-09; emenda as partes 2 e 3 da DEC-013 | APROVADA |
