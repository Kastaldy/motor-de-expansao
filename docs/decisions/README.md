...
- [DEC-030](DEC-030.md) — As **independentes entram na oferta** do sinal 6, com metade do peso de uma unidade de rede; o insumo só tinha cadeias, então 37,8% do universo marcava `0` e **32,3% tinha sinal invisível**. Carimbo `universo_oferta`, auto-exclusão e dedup entre fontes; score vai a `v5` — BLK-MA-16 (**PENDENTE**: código pronto e desligado por default)
