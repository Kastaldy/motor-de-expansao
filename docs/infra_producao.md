...
2026-08-25; revogada pela DEC-063 em 2026-09-17)*. A partição do **TotalPass é gravada desde a
...
a FONTE ficar fora da série; desde a DEC-063 é o **SINAL** ficar fora da conta — `s1` está em
...
`--fontes wellhub` reproduz o universo anterior à DEC-063 (19.329) sem mexer em código.
...
> 36,99% que a DEC-063 mediu. Os dois atos são inseparáveis.
...
canônicas do próprio repositório o omitiam. A lição sobrevive à DEC-063 e é por isso que o default
...
> 2026-08-25; default trocado pela DEC-063 em 2026-09-17)*. Omitir o flag aplica
...
> wellhub`". Para reproduzir o universo anterior à DEC-063 (19.329 academias): `--fontes wellhub`.
