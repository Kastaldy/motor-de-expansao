...
**Domínio com os 10 melhores e zoom na melhor área (2026-09-17).** A camada de Domínio pintava e numerava os 154 hexágonos aprovados de São Paulo; passa a numerar só os 10 melhores pela régua de "Onde crescer" (`service.TOP_HEXES_DOMINIO`, os 5 primeiros são os da página). Resumo e Domínio enquadram esses hexágonos (`_focus_bounds_mercator(hexes_foco=...)`), o Resumo com margem maior (`_FOCUS_PAD_FRAC_RESUMO`, limitada ao quadro da cidade: ali a pergunta é quanto espaço há no município), o mapa de "Onde crescer" fecha nos 5 escolhidos (`relatorio_praca_mapas.quadro_onde_crescer`), e os demais mapas ganharam uma aproximação leve (`_FOCUS_MIN_SPAN_M` 6.000 -> 5.000 m e `_FOCUS_PAD_FRAC` 0,16 -> 0,08).
