...
export interface PinIndependente {
  ...
  lng: number | null
  nome: string
  /** `[DEC-066]` App que revelou a academia (`wellhub` | `totalpass`) — decide a arte do pino.
   *  Opcional: em payload antigo o mapa cai na marca do Wellhub, que era o universo inteiro. */
  fonte?: string | null
  /** `[DEC-066 / fatia 2]` QUAIS apps listam a academia, separados por vírgula
...
export interface RedeMapaConcorrente {
  ...
  fonte?: string | null
  /** `[DEC-066 / fatia 2]` QUAIS apps listam a academia. Com vírgula, terceiro estado. */
  fontes_da_academia?: string | null
  distancia_m: number | null
