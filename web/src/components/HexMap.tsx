...
// Logo do APP que revelou a academia, para os pins de INDEPENDENTES. `[DEC-064]` Ate' 2026-09-17
...
// `[DEC-064 / fatia 2]` O terceiro estado: academia nos DOIS apps. Arte COMPOSTA das outras duas
...
/** Sem `fonte` (payload antigo) cai no WellHub, que era o universo inteiro ate' a DEC-064. */
  ...
  const camadas = useMemo(() => {
    const base: Layer[] = [
      ...
      /* INDEPENDENTES (BLK-MA-15): logo do AGREGADOR que as revelou — pedido do Felipe
         (2026-08-25), que a `[DEC-064]` desdobra em DOIS apps: ate' ela, "a marca do agregador"
