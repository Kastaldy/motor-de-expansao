 ...
 */
export default function BlocoViabilidadePonto({
  lat,
  lng,
  onDetalhes,
  onResultado,
  ...
  return (
    <div style={{ display: 'grid', gap: 14 }}>
      <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'flex-end' }}>
        ...
        {/* A ficha coleta 3 entradas (metragem, aluguel, alunos) porque e' o minimo
            para o motor rodar. A tela de Viabilidade tem as outras 10 — ticket, obra,
            equipamentos, taxa de franquia, carencia de aluguel, prazos, taxa minima.
            Quem precisa mexer nelas vai para la, no MESMO ponto, em vez de reabrir a
            busca. */}
        <Botao variante="ghost" onClick={onDetalhes}>
          Mais detalhes →
        </Botao>
      </div>
