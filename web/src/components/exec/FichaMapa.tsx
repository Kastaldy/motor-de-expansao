...
/* ---------------------------------------------------------------------------
   ...
   operador não aprender duas legendas. `[DEC-063]` Até 2026-09-17 era sempre o
...
/** `[DEC-063 / fatia 2]` Academia nos DOIS apps. Arte COMPOSTA das outras duas e gerada por
...
/** `[DEC-063]` A marca sai do app. Sem `fonte` (payload antigo) cai no Wellhub — que era o
        ...
        {camada ? (
          ...
          <>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              {/* [DEC-063] DUAS entradas, porque agora há duas artes. Esta legenda chegou a ficar
